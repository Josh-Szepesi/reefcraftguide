---
layout: post
title: "Powerhead Placement and Flow in a Reef Aquarium"
date: 2026-03-22
description: "Learn how to place powerheads correctly in a reef tank to create turbulent flow, eliminate dead spots, and keep corals and fish healthy. Includes flow rate targets by tank type."
image: /assets/images/2026-03-22-powerhead-placement-and-flow-reef-aquarium.jpg
...
<p class="image-credit">Photo by <a href="https://unsplash.com/@niklas_2011?utm_source=artlines_blog&utm_medium=referral">Niklas Plenter</a> on <a href="https://unsplash.com/?utm_source=artlines_blog&utm_medium=referral">Unsplash</a></p>
...
The [Hydor Koralia Nano 240 Circulation Pump](https://www.amazon.com/s?k=hydor+koralia+nano+circulation+pump&tag=reefcraft-20) is a solid AC option for nano tanks and as a supplemental circulation pump - straightforward, quiet, and easy to position with the magnetic mount. For a mid-size reef running 30-75 gallons, the [Jebao OW Sine Wave Powerhead](https://www.amazon.com/s?k=jebao+OW+sine+wave+powerhead+reef&tag=reefcraft-20) gives you DC control and multiple wave modes at a reasonable price point. For larger SPS-dominated systems where flow volume and precision matter most, the [EcoTech Marine VorTech MP10](https://www.amazon.com/s?k=ecotech+marine+vortech+MP10+powerhead&tag=reefcraft-20) is the benchmark - the wet and dry motor halves mount on either side of the glass, eliminating all hardware from the water column and allowing for fine-grained reef crest simulation modes.
...
**Running a skimmer in a low-flow area.** Protein skimmers work best when the intake is in an area of active water movement - a [protein skimmer](https://reefcraftguide.com/2026/03/11/protein-skimmer-guide) positioned in a dead spot at the back of the sump will pull from stagnant water rather than the main water column, reducing efficiency.
...
- [Hydor Koralia Nano 240 Circulation Pump](https://www.amazon.com/s?k=hydor+koralia+nano+circulation+pump&tag=reefcraft-20) - reliable AC powerhead for nano tanks and supplemental flow
- [Jebao OW Sine Wave Powerhead](https://www.amazon.com/s?k=jebao+OW+sine+wave+powerhead+reef&tag=reefcraft-20) - DC wavemaker with multiple modes, solid value for mid-size reef tanks
- [EcoTech Marine VorTech MP10 Powerhead](https://www.amazon.com/s?k=ecotech+marine+vortech+MP10+powerhead&tag=reefcraft-20) - premium through-glass mount powerhead with advanced wave control for SPS-focused systems

## Related Reading

- [Protein Skimmers for Small Reef Tanks](https://reefcraftguide.com/2026/03/11/protein-skimmer-guide)
- [Reef Tank Water Chemistry: Alkalinity, Calcium, and Magnesium](https://reefcraftguide.com/2026/03/11/reef-tank-water-chemistry)
- [How to Control Algae in a Reef Tank](https://reefcraftguide.com/2026/03/16/controlling-algae-in-reef-tank)
- [Reef Tank Setup for Beginners](https://reefcraftguide.com/2026/03/11/reef-tank-setup-for-beginners)

If you are setting up flow for the first time, the [reef tank setup for beginners](https://reefcraftguide.com/2026/03/11/reef-tank-setup-for-beginners) guide covers all the core equipment decisions including return pumps and circulation as part of the overall system build.
