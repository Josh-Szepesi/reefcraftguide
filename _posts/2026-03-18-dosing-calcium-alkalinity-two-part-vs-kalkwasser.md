...
I use a dosing pump set to dose 10 ml of each part four times a day in my 90-gallon mixed reef. That works out to roughly 40 ml per day of each solution - which cost me about $0.30 per day using bulk BRS chemicals. [BRS two-part dosing chemicals](https://www.amazon.com/s?k=BRS+two+part+dosing+reef+tank&tag=reefcraft-20) are widely available and the most common starting point for hobbyists.
...
[Kalkwasser powder](https://www.amazon.com/s?k=kalkwasser+powder+reef+tank&tag=reefcraft-20) is inexpensive compared to two-part solution. A 1 kg bag of calcium hydroxide costs $15-30 and can last several months in a 75-gallon mixed reef.
...
For many reef keepers, the best long-term approach is using both together. I currently run kalkwasser through my ATO for the baseline daily top-off, and I have a two-part setup on standby to supplement when alkalinity drops faster than evaporation can cover. This combination reduces two-part consumption while keeping full control. An [automatic dosing pump](https://www.amazon.com/s?k=aquarium+dosing+pump+reef&tag=reefcraft-20) for the two-part side runs about $60-100 and pays for itself quickly in reduced two-part usage.

## Setting Up Two-Part Dosing: Quick Start

1. **Measure your baseline** - Test calcium and alkalinity daily for 3 days without dosing to establish your tank's natural consumption rate
2. **Calculate starting dose** - A common starting point for a 75-gallon system is 5-10 ml per day of each part, then adjust
3. **Spread the dose** - Set your pump to 4-6 increments per day rather than one large daily dose
4. **Retest after 3-4 days** - Adjust up or down by 10-20% at a time until parameters hold steady
5. **Check magnesium monthly** - If calcium and alkalinity will not stay up despite dosing, low magnesium is usually the cause

A detailed look at how water chemistry fits into your overall [reef tank maintenance schedule](https://reefcraftguide.com/2026/03/11/reef-tank-maintenance-schedule) can help you build testing into a consistent routine.

## Setting Up Kalkwasser Through an ATO: Quick Start

1. **Mix kalk solution** - Add 1-2 teaspoons of calcium hydroxide powder per gallon of RO/DI water. Saturated solution forms at about 2 grams per liter; undissolved powder settles and is harmless
2. **Never shake or agitate** - Pouring or pumping from above the settled powder avoids introducing excess calcium hydroxide into your tank
3. **Set ATO dose rate conservatively** - Start with small doses (under 200 ml at a time) and monitor pH after doses. Your tank pH should not spike above 8.4-8.5 from a single ATO top-off
4. **Test calcium and alkalinity weekly** - If demand exceeds what kalk through the ATO can supply, supplement with small amounts of two-part until you find the right balance

The chemistry of kalk is well-documented in Randy Holmes-Farley's reef chemistry series at [Advanced Aquarist](https://www.advancedaquarist.com/), which is one of the most thorough non-commercial resources on the subject.
...
- [Reef Tank Water Chemistry for Beginners](https://reefcraftguide.com/2026/03/11/reef-tank-water-chemistry)
- [Reef Tank Maintenance Schedule](https://reefcraftguide.com/2026/03/11/reef-tank-maintenance-schedule)
- [Setting Up a Refugium: Step-by-Step](https://reefcraftguide.com/2026/03/11/refugium-setup-guide)
