---
layout: post
title: "How to Set Up an Aquarium Sump: A Complete Beginner Guide"
date: 2026-03-11
description: "Learn how to plan, build, and plumb an aquarium sump for your reef tank, including sump sizing, chamber layout, plumbing options, and equipment placement."
tags: [sump, reef tank, plumbing, filtration, setup]
image: /assets/images/2026-03-11-aquarium-sump-setup-guide.jpg
---
...
![How to Set Up an Aquarium Sump: A Complete Beginner Guide](/assets/images/2026-03-11-aquarium-sump-setup-guide.jpg)

<p class="image-credit">Photo by <a href="https://unsplash.com/@derekleej?utm_source=artlines_blog&utm_medium=referral">Derek Lee</a> on <a href="https://unsplash.com/?utm_source=artlines_blog&utm_medium=referral">Unsplash</a></p>

## Why a Sump Makes Your Reef Tank Better

<div class="safety-note">
**Safety Note:** Always use GFCI-protected outlets for all aquarium electrical equipment. When drilling a tank for a sump overflow, use proper diamond-tipped hole saws and have someone guide the process - a cracked tank is a flooded floor.
</div>
...
A sump also moves equipment out of your display. Heaters, [protein skimmer](/2026/03/11/protein-skimmer-guide.html)s, return pumps, and refugium sections all live in the sump, leaving your display tank clean and uncluttered. Maintenance becomes faster because everything is accessible in one place underneath the tank rather than scattered inside a visible aquarium.
...
For most home reef tanks in the 50 to 120-gallon range, the [Sicce Syncra SDC](https://amzn.to/placeholder) and the [Reef Octopus VarioS](https://amzn.to/placeholder) are well-regarded variable-speed return pumps that let you dial in the exact flow rate you want.
...
Loc-Line flexible tubing makes aiming return nozzles easy without cutting hard pipe. [Loc-Line 1/2-inch modular hose kits](https://amzn.to/placeholder) are inexpensive and available in most aquarium stores.
...
The Reef2Reef community maintains an extensive [sump design thread](https://www.reef2reef.com/) with real-world builds and plumbing diagrams from experienced hobbyists.

## FAQ

**Does my reef tank need a sump?**
No, but it helps enormously. All-in-one tanks with built-in rear filter chambers offer a middle ground. A true sump adds more volume, more equipment space, and more flexibility than any AIO compartment.

**Can I build my own sump?**
Yes. A DIY sump from a standard glass aquarium with silicone baffles and a coat of black spray paint on the outside is functionally identical to a commercial sump and costs a fraction of the price. Many hobbyists use a used 20-gallon long aquarium as their first sump.

**How do I stop my sump from making noise?**
Most sump noise comes from the drain line. A properly configured Herbie or bean animal overflow runs near-silently. If you have an existing noisy drain, adding a Stockman standpipe insert and adjusting the drain valve usually solves it. Submerging the drain outlet below the water surface in the sump also eliminates splash noise.

**What is the best water level to maintain in the return chamber?**
Keep the return chamber at least one-third full at all times to prevent the pump from running dry. An ATO system tied to a float switch or optical sensor in the return chamber keeps the level consistent automatically.
...
- [Refugium Setup Guide](/2026/03/11/refugium-setup-guide.html)
- [Protein Skimmer Guide](/2026/03/11/protein-skimmer-guide.html)

A sump pairs naturally with a refugium. Read our [Refugium Setup Guide](/2026/03/11/refugium-setup-guide.html) to add a chaeto chamber to your system.
