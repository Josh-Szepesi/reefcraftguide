...
In a broader sense, coral fragging mirrors what conservation organizations like the [Coral Restoration Foundation](https://www.coralrestorationfoundation.org/) do to propagate threatened reef corals at scale. For the home reef keeper, the goals are more modest - but the process is the same. I have been fragging corals across several tanks for about four years now, and I find it gives me a better understanding of how each coral grows and what it needs to thrive.
...
**Xenia and pulsing corals** frag easily with clean scissors. Snip a stalk with two or three polyps attached. To mount the frag, apply a small amount of [coral frag epoxy](https://www.amazon.com/s?k=coral+frag+epoxy&tag=reefcraft-20) to the base and press it onto a plug. Xenia usually starts pulsing again within 48 hours in my experience.
...
For a closer look at which soft corals are easiest to keep and frag, see our guide to [beginner corals that are hard to kill](https://reefcraftguide.com/2026/03/11/coral-care-for-beginners.html).
...
5. Apply epoxy to the base and press the frag onto a [frag plug](https://www.amazon.com/s?k=coral+frag+plugs&tag=reefcraft-20). I prefer 3/4-inch plugs for most SPS pieces.
...
- **Water quality:** Stable and clean. I do not skip a single water change during frag recovery, and I test parameters more frequently than usual. Everything I do for regular maintenance during this period is described in our [reef tank maintenance schedule](https://reefcraftguide.com/2026/03/11/reef-tank-maintenance-schedule.html).
...
- [Beginner Corals That Are Hard to Kill](https://reefcraftguide.com/2026/03/11/coral-care-for-beginners.html)
- [Reef Tank Water Chemistry for Beginners](https://reefcraftguide.com/2026/03/11/reef-tank-water-chemistry.html)
- [Reef Tank Maintenance Schedule](https://reefcraftguide.com/2026/03/11/reef-tank-maintenance-schedule.html)

If you are just starting with coral keeping, read our [guide to beginner corals](https://reefcraftguide.com/2026/03/11/coral-care-for-beginners.html) first - having healthy, established colonies before you start fragging gives you much better outcomes and more confidence with the process.
